...
include 'class_lib.php';
      ...
      echo 'Preparing location to town matches'.'<br>';
      ...
      //$loc_to_town reserves all matched records in relative tables 
      //and deactivates the reserved option in other linked tables
      $loc_to_town = new prep_match_data();
            
      $dup_keys1 = 'mcs_client_ec_no';
      $dup_keys2 = 'EC_NO';
      echo 'The number of unique matches found is '.$loc_to_town->get_match($matched_records,$dup_keys1, $dup_keys2).'.'.'<br>';
      
      $loc_to_town->create_matched_recs();

      $loc_to_town->update_tables();
